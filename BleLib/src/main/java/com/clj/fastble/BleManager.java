...
public class BleManager {
     ...
     * @param callback
     */
    public BluetoothGatt connectDevice(ScanResult scanResult,
                              boolean autoConnect,
        ...
        if (scanResult == null || scanResult.getDevice() == null) {
            ...
            return bleBluetooth.connect(scanResult, autoConnect, callback);
        }
    }
     ...
     * beck callback
     */
    public HashMap<String, BluetoothGattCallback> getCallbackHashMap(){
        return bleBluetooth.getCallbackHashMap();
    }
}
