...
public class BloodSugarSuggestionActivity extends BaseActivity implements
		OnClickListener {
	...
	private void setData() {
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedSslError(WebView view,final SslErrorHandler handler,
										   SslError error) {
				final AlertDialog.Builder builder = new AlertDialog.Builder(BloodSugarSuggestionActivity.this);
