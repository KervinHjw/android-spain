...
import com.ludees.scian.setting.AboutActivity;
 ...
 * 
 */
public class DailyRecommendationActivity extends BaseActivity implements
		OnClickListener {
	...
	private void setData() {
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedSslError(WebView view,final SslErrorHandler handler,
										   SslError error) {
				final AlertDialog.Builder builder = new AlertDialog.Builder(DailyRecommendationActivity.this);
