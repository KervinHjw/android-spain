...
public class RegistrationAgreementActivity extends BaseActivity {
	...
	private void setData() {
		webView.loadUrl("http://139.196.106.123/lude/staticPage/registrationAgreement.html");
		// 覆盖WebView默认使用第三方或系统默认浏览器打开网页的行为，使网页用WebView打开
				webView.setWebViewClient(new WebViewClient() {
					...
					public void onReceivedSslError(WebView view,final SslErrorHandler handler,
												   SslError error) {
						final AlertDialog.Builder builder = new AlertDialog.Builder(RegistrationAgreementActivity.this);
