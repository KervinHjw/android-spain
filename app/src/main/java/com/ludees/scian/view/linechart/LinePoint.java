...
public class LinePoint {
	...
	private boolean isDrawTextBackground = false;
    /**
	...
	public boolean isDrawTextBackground() {
		return isDrawTextBackground;
	}

	public void setDrawTextBackground(boolean isDrawTextBackground) {
		this.isDrawTextBackground = isDrawTextBackground;
	}
